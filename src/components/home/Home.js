    ...
    <div className="Home">
      ...
      <div className="container my-4">
        ...
        <div className="container social-media text-center my-5">
          ...
          <a href="#top"><i className="fab fa-2x fa-linkedin"></i></a>
          <a href="#top"><i className="fab fa-2x fa-instagram"></i></a>
          <a href="#top"><i className="fab fa-2x fa-github-square"></i></a>
          <a href="#top"><i className="fab fa-2x fa-twitter-square"></i></a>
